...
def train_mobilenet(batch_size, epoch):
    ...
    checkpoint = tf.keras.callbacks.ModelCheckpoint('{epoch}_epoch_mobilenetv3_weight.h5',
...
def test_mobilenet(model_path, batch_size):
    dataLoader = DataLoader()
...
if __name__ == '__main__':
    # 训练
    train_mobilenet(256, 80)
    # 测试
    # test_mobilenet('./weight/80_epoch_mobilenetv3_weight.h5', 10000) # Data augmentation + 80 epoch Adam lr 0.001 decay 1e-6 84.06; data 60 epoch Adam lr 0.001 decay 1e-7 65.69